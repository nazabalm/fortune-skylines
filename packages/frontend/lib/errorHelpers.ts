...
export function parseContractError(error: any): string {
  ...
  if (
    errorLower.includes("usdc transfer failed") ||
    errorLower.includes("transfer failed")
  ) {
  ...
  if (
    ...
    errorLower.includes("exceeds allowance")
  ) {
  ...
  if (
    ...
    errorLower.includes("per") &&
    errorLower.includes("day")
  ) {
    return "⚠️ This referrer has reached the daily referral limit.";
  }
